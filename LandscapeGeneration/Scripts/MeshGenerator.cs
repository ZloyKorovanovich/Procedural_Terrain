...
public class MeshGenerator
{
    ...
    private const int _THREAD_GROUP_SIZE_X = 2;
    private const int _THREAD_GROUP_SIZE_Y = 2;
    ...
    public void GenerateChunk(RenderTexture heightMap, out Mesh[] tileLODs)
    {
        tileLODs = new Mesh[(int)_maxResolution - 1];
        for(int i = 1; i < (int)_maxResolution; i++)
        {
